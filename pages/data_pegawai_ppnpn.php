            ...
            <div class="card-body">
              <div class="table-responsive">
				...
				<tfoot>
                  ...
                  <tbody>
                    <?php
					//$link     = mysqli_connect("202.90.198.136", "root", "P@ssw0rdbmkg2020", "diklatdb2");
					include "koneksi.php";
					$sql = mysqli_query($koneksi, "SELECT * FROM spt_peserta_eksternal ORDER BY nip desc");
                    ...
                    <tr>
					  ...
					  <td><a href="<?php echo "index2a.php?data=hapus_pegawai_ppnpn&idx=".$r['nip']; ?>"><i class="fas fa-eraser fa-2x" onclick="return deleteconfig()"></i></a>
					</td>
...
<?php
			...
			include "koneksi.php";
			$sql      = mysqli_query($link, "SELECT * FROM spt_peserta_eksternal ");	
			while ($r = mysqli_fetch_array($sql)) {
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
     <div class="modal-header">
				 ...
				 <div class="modal-body">
					<form action="index2a.php?data=edit_peserta_ppnpn" method="POST">
...
{   //$no =$_POST['no'];
	...
	$cekdulu= "select * from spt_peserta_eksternal where nip='$_POST[nip]'"; //username dan $_POST[un] diganti sesuai dengan yang kalian gunakan
	...
	
	{
		echo "<script>alert('Maaf.. Data Sudah Ada');
			...
			$input = mysql_query("insert into spt_peserta_eksternal set 
											nip ='$nip', 
