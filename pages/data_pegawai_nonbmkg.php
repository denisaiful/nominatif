...
<?php
			...
			include "koneksi_136.php";
			$sql      = mysqli_query($koneksi, "SELECT * FROM spt_peserta_nonbmkg1 ");	
			while ($r = mysqli_fetch_array($sql)) {
...
{   //$no =$_POST['no'];
	...
	$prosescek= mysqli_query($link,$cekdulu);
	...
	
	{
		echo "<script>alert('Maaf.. Data Sudah Ada');
			...
			$input = mysqli_query($link,"insert into spt_peserta_nonbmkg1 set 
											nip ='$nip', 
