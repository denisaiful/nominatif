              ...
              <div class="table-responsive">
				...
				<tfoot>
                  ...
                  <tbody>
                    ...
                    include "koneksi.php";
                    $sql = mysql_query("SELECT * FROM data_spt3 where nama_peserta like'%$_POST[key]%' OR nip_peserta like'%$_POST[key]%' OR bulan_rom like'%$_POST[key]%' OR lokasi like'%$_POST[key]%' OR kegiatan like'%$_POST[key]%' order by no_peserta desc");
                    $no = 1;
...
{   //$no =$_POST['no'];
	$sumber_dana =$_POST['sumber_dana'];
			...
			$input = mysql_query("insert into sumber_dana set 
